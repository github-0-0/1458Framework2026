...
public class TestAutoMode3 extends AutoStringAuto {
    public TestAutoMode3()   {     
        ...
        super("Elevator DEF S 4 R 6 Elevator L4 CShoot Wait 1 Elevator DEF CS 1 R 6");// CS 1 R 1 CS 1 R 2 CS 1 ");//R 3 CS 1 R 4 CS 1 R 5 CS 1 R 6");//CS 1 R 2 CS 1");//left side routine
