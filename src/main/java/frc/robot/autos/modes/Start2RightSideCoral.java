...
public class Start2RightSideCoral extends AutoModeBase {
    ...
    public Start2RightSideCoral() {
        autoString = "S 2 R 6 Snap 0 Elevator 4 CShoot Elevator 0"
                   + "( CS 1 CIntake R 1 Snap 0 Elevator 4 CShoot Elevator 0 ) "
                   + "( CS 1 CIntake R 2 Snap 0 Elevator 4 CShoot Elevator 0 ) "
                   + "( CS 1 CIntake R 2 Snap 0 Elevator 3 CShoot Elevator 0 )";
    }
