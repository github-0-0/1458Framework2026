...
public class FieldLayout {
    ...
    public static Translation2d[] offsets = {
		new Translation2d(Constants.Swerve.trackWidth/2 + 0.20, -0.266),//left bar, 3.5 bumper + 3 inch space
		new Translation2d(Constants.Swerve.trackWidth/2 + 0.20, 0.066),//right bar
		new Translation2d(Constants.Swerve.trackWidth/2 + 0.20,0.0),//center of reef
